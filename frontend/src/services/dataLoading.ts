...
import {
  addUser, addUsers, generalUsersStore, removeUser,
} from '../stores/generalUsersStore';
import {
  HttpError, loadUser, loadUsers, NetworkError,
} from './api';
...
export function loadAndSetUser(userId: UserId)
  : [Readable<UserDTO>, Readable<HttpError | NetworkError>] {
